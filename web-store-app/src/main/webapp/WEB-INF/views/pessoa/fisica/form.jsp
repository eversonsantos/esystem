	...
	<div class="row">
		...
		<div class=" col-md-2 col-xs-6">
			<div class="form-group">
			  ...
			  <input class="form-control input-sm nasc" name="cdPfis.dtNasc"/>
			</div>
		</div>
	...
	<div class="row">				
		<div class=" col-md-4 col-xs-6">
			<div class="form-group">
			  ...
			  <select class="form-control input-sm select2" style="width: 100%;" name="cdPfis.dsEstCivil">
		...
		<div class=" col-md-4 col-xs-6">
			<div class="form-group">
			  ...
			  <select class="form-control input-sm select2" style="width: 100%;" name="cdPfis.dsEsc">
			    <option value="null">Selecione..</option>
